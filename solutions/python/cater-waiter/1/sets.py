...
def tag_special_ingredients(dish):
    ...
    spec_ingrediants = SPECIAL_INGREDIENTS.intersection(dish[1])
    return (dish[0], spec_ingrediants)
...
def compile_ingredients(dishes):
    ...
    union_set = set()
    for dish in dishes:
        union_set = union_set.union(dish)
    return union_set
...
def singleton_ingredients(dishes, intersection):
    ...
    for dish in dishes:
        print("Dish", dish)
        singleton_set
        singleton_set.append(dish.difference(intersection))
